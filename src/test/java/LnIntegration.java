...
public class LnIntegration {
    ...
    public void SetUp(){
        ...
        piecewiseFunction.getLogarithmicFunction().getLog2().getLn().setFuncIsStub(false);
        piecewiseFunction.getLogarithmicFunction().getLog3().getLn().setFuncIsStub(false);
        piecewiseFunction.getLogarithmicFunction().getLog5().getLn().setFuncIsStub(false);
        piecewiseFunction.getLogarithmicFunction().getLog10().getLn().setFuncIsStub(false);
